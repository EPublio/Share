...
foreach($nots as $n){
    ...
    if($status == 'Andamento'){
        ...
        if($id_user1==$_SESSION['id_user']){
            ...
            echo '<h2><span class="nome-verde">Telefone: </span> <a href="https://api.whatsapp.com/send?phone=55' . $telefone['numero_telefone'] . '&text=Ol%C3%A1,%20aqui%20%C3%A9%20o(a)%20' . $login2['login'] . '%20do%20Share,%20entrei%20em%20contato%20por%20conta%20da%20nossa%20troca,%20como%20vamos%20realiza-l%C3%A1?" class="link">'.$telefone['numero_telefone'].'</a></h2>';
